...
const Dashboard = () => {
  ...
  return (
    <div className=" bg-gray-50 flex items-center  justify-center h-150 p-6 shadow-lg drop-shadow-2xl w-315">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-400 h-100 max-w-5xl shadow-lg drop-shadow-2xl">
        ...
        <div className="bg-white shadow-lg rounded-2xl relative py-6 px-6 flex flex-col h-full">
          <h2 className="text-l  font-bold flex  w-30 items-center justify-center">Subject:</h2> 
          <div className="flex-1 flex flex-col   h-50 gap-3 w-120 items-center ">
            <div className=" flex h-80  w-120 items-center  flex-col gap-2 ">
